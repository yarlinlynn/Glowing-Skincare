                ...
                <ul class="has-scrollbar">
                        ...
                        <div class="shop-card">
                            ...
                            <div class="bg-[var(--light-gray)] aspect-[540/720] relative">
                                <img class="transition-[var(--transition-2)] w-full h-full object-cover"
                                    src="../public/images/products/product-07.jpg" alt="Facial cleanser" loaading="lazy" width="540" height="720"
                                />
                    ...
                    <li class="snap-start min-w-full sm:min-w-[calc(50%-15px)] md:min-w-[calc(33.33%-20px)] lg:min-w-[calc(20%-24px)]">
                        <div class="shop-card">
                            ...
                            <div class="bg-[var(--light-gray)] aspect-[540/720] relative">
                                <img class="transition-[var(--transition-2)] w-full h-full object-cover"
                                    src="../public/images/products/product-08.jpg" alt="Bio-shroom Rejuvenating Serum" loaading="lazy" width="540" height="720"
                                />
                    ...
                    <li class="snap-start min-w-full sm:min-w-[calc(50%-15px)] md:min-w-[calc(33.33%-20px)] lg:min-w-[calc(20%-24px)]">
                        <div class="shop-card">
                            ...
                            <div class="bg-[var(--light-gray)] aspect-[540/720] relative">
                                <img class="transition-[var(--transition-2)] w-full h-full object-cover"
                                    src="../public/images/products/product-09.jpg" alt="Coffee Bean Caffeine Eye Cream" loaading="lazy" width="540" height="720"
                                />
                    ...
                    <li class="snap-start min-w-full sm:min-w-[calc(50%-15px)] md:min-w-[calc(33.33%-20px)] lg:min-w-[calc(20%-24px)]">
                        <div class="shop-card">
                            ...
                            <div class="bg-[var(--light-gray)] aspect-[540/720] relative">
                                <img class="transition-[var(--transition-2)] w-full h-full object-cover"
                                    src="../public/images/products/product-10.jpg" alt="Facial cleanser" loaading="lazy" width="540" height="720"
                                />
                    ...
                    <li class="snap-start min-w-full sm:min-w-[calc(50%-15px)] md:min-w-[calc(33.33%-20px)] lg:min-w-[calc(20%-24px)]">
                        <div class="shop-card">
                            ...
                            <div class="bg-[var(--light-gray)] aspect-[540/720] relative">
                                <img class="transition-[var(--transition-2)] w-full h-full object-cover"
                                    src="../public/images/products/product-11.jpg" alt="Coffee Bean Caffeine Eye Cream" loading="lazy" width="540" height="720"
                                />
